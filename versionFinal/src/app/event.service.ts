...
const BASIC_URL = 'http://127.0.0.1:8081/Event'
...
export class EventService {
  private apiServer: string = 'http://127.0.0.1:8081/Event/api/evenement/';
  private baseURL: string = 'http://127.0.0.1:8081/Event/api/evenement/get';
  __URL = 'http://127.0.0.1:8081/Event/api/Event/cloudinary';
  ...
  addEvent(event: Event) {
    return this._http.post<Event>(this.apiServer + 'add', event, this.httpOptions);
  }


  updateEvent(event: Event) {
    return this._http.put<Event>(this.apiServer + 'update', event, this.httpOptions);
  }
