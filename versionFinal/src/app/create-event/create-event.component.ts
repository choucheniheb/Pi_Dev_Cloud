...
event:Event = { 
  ...
  ngOnInit(): void {
    this.eventForm = this.formBuilder.group({
      ...
      type: ['', [Validators.required, Validators.minLength(4), this.containsNumberValidator]],
      lieu: ['', [Validators.required, Validators.minLength(4), this.containsNumberValidator]],
